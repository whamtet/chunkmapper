...
public class BoundedPointManager implements PointManager {
	...
	public BoundedPointManager(File chunkmapperFolder, MappedSquareManager mappedSquareManager, Point rootPoint) {
		double west = 166.22, east = 178.8;
		double north = -34, south = -47.4;
		nesw = new double[] {north, east, south, west};
	...
	private HashSet<Point> getSurroundingPoints(int regionx0, int regionz0, Point rootPoint) {
		...
		int regionx1 = (int) Math.floor(nesw[3] * 3600 / 512) - rootPoint.x;
		int regionx2 = (int) Math.floor(nesw[1] * 3600 / 512) - rootPoint.x;
		int regionz1 = (int) Math.floor(-nesw[0] * 3600 / 512) - rootPoint.z;
		int regionz2 = (int) Math.floor(-nesw[2] * 3600 / 512) - rootPoint.z;
