...
public class LakeResourceInfo extends ResourceInfo {

	public static final String FORMAT_URL = "http://www2.demis.nl/WMS/wms.ashx?wms=WorldMap&VERSION=1.1.1&REQUEST=GetMap&SRS=EPSG:4326&WIDTH=512&HEIGHT=512&LAYERS=Waterbodies&STYLES=default&TRANSPARENT=TRUE&FORMAT=image/gif&bbox=%s,%s,%s,%s";
	public static final File CACHE_DIRECTORY = new File(Utila.CACHE, "demisLakes");
	static {
		if (!CACHE_DIRECTORY.exists())
			CACHE_DIRECTORY.mkdirs();
	}

	public LakeResourceInfo(int regionx, int regionz) {
	...
	public static void main(String[] args) throws Exception {
		LakeResourceInfo info = new LakeResourceInfo(0, 0);
