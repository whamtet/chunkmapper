...
String s = "http://www.overpass-api.de/api/xapi?way[place=*][bbox=%s,%s,%s,%s]";
return new URL(getAddress(s, regionx, regionz));
}
...
String s = "http://www.overpass-api.de/api/xapi?way[railway=rail%spreserved][bbox=%s,%s,%s,%s]";
...
return new URL(String.format(s, "%7C", lon1, lat1, lon2, lat2));
}
