...
public class DeciduousBroadleafChunk extends Chunk {

	public static TriangleZonator zonator = new TriangleZonator();
	private static final Sobol sobol = new Sobol(15, new TreeGenerator() {
		public byte getTreeHeight() {
			return (byte) (3 + RANDOM.nextInt(3));
		}
	});
	static {
	...
	public DeciduousBroadleafChunk(int absChunkX, int absChunkZ, int[][] heights) {
